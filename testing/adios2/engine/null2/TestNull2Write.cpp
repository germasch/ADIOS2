...
class Null2WriteTest : public ::testing::Test
{
public:
    Null2WriteTest() = default;
...
TEST_F(Null2WriteTest, ADIOS2Null2Write1D8)
{
...
// ADIOS2 BP write, native ADIOS1 read
TEST_F(Null2WriteTest, ADIOS2Null2Write2D2x4)
{
    int mpiRank = 0, mpiSize = 1;
    // Number of rows
...
TEST_F(Null2WriteTest, ADIOS2Null2Write2D4x2)
{
    // Each process would write a 4x2 array and all processes would
    // form a 2D 4 * (NumberOfProcess * Nx) matrix where Nx is 2 here
    std::string fname = "ADIOS2Null2Write2D4x2Test.bp";
